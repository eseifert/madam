...
def test_create_asset_from_wav():
    asset = madam.audio.WaveProcessor()._read('tests/resources/16-bit-mono.wav')
...
def test_create_asset_from_mp3():
    ...
    with open(mp3_file_path, 'rb') as mp3_file:
        asset = madam.audio.MutagenProcessor()._read(mp3_file)
...
def test_mp3_reader_does_not_change_file():
    ...
    with open(mp3_file_path, 'rb') as mp3_file:
        madam.audio.MutagenProcessor()._read(mp3_file)
    with open(mp3_file_path, 'rb') as mp3_file:
