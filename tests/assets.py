...
@pytest.fixture(scope='session', params=['jpeg_image_asset', 'png_image_asset', 'gif_image_asset', 'webp_image_asset'])
def image_asset(request, jpeg_image_asset, png_image_asset, gif_image_asset, webp_image_asset):
